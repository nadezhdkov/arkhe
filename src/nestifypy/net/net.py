...
nestifypy.net
-------------
NestifyPy Net – Cliente HTTP fluente para o ecossistema Nestifypy.
...
class NetError(Exception):
    """Base exception para erros do nestifypy.net."""
...
class _DiskCache:
    ...
    def __init__(self, directory: Union[str, Path] = ".nestifypy/cache") -> None:
        ...
        try:
            ...
            try:
                ...
                raise ImportError(
                    ...
                    "Coloque promise.py no mesmo diretório ou instale nestifypy-promise."
                )
...
def request(url: str) -> Request:
    """
    Ponto de entrada principal do nestifypy.net.
