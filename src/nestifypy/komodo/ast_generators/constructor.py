"""
nestifypy.komodo.ast_generators.constructor
-------------------------------------------
...
from nestifypy.komodo.ast_builders import make_arg, make_arguments, make_function, make_attribute_assign
from nestifypy.komodo.ast_generators.utils import get_fields_from_ast, get_defaults_from_ast, mark_komodo_meta
...
def generate_constructor(class_def: ast.ClassDef, cls: Type, mode="all"):
    ...
    mark_komodo_meta(cls, f"{mode}_constructor")
