"""
nestifypy.collections.unmodifiable
------------------------------------
Runtime unmodifiable wrappers for nestifypy collections.

This module provides :func:`unmodifiable` — a factory that wraps **any**
nestifypy collection in a read-only proxy at runtime, identical to Java's

    Collections.unmodifiableList(list)
    Collections.unmodifiableSet(set)
    Collections.unmodifiableMap(map)

Unlike :class:`~nestifypy.collections.immutable_list.ImmutableList` and
:class:`~nestifypy.collections.immutable_array.ImmutableArray` (which are
...
Usage::
    ...
    from nestifypy.collections import ArrayList, HashMap
...
--------------------------
- :class:`~nestifypy.collections.array_list.ArrayList`
- :class:`~nestifypy.collections.linked_list.LinkedList`
- :class:`~nestifypy.collections.stack.Stack`
- :class:`~nestifypy.collections.queue.Queue`
- :class:`~nestifypy.collections.ordered_set.OrderedSet`
- :class:`~nestifypy.collections.hash_map.HashMap`
- :class:`~nestifypy.collections.bi_map.BiMap`
- :class:`~nestifypy.collections.multi_map.MultiMap`
- :class:`~nestifypy.collections.priority_queue.PriorityQueue`
- :class:`~nestifypy.collections.circular_buffer.CircularBuffer`
"""
...
from nestifypy.collections.immutable_list import UnsupportedOperationException
...
class UnmodifiableWrapper(Generic[T]):
    """
    A transparent read-only proxy around any nestifypy collection.
