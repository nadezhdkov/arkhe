"""
nestifypy.collections.immutable_list
--------------------------------------
...
Example::
    ...
    from nestifypy.collections import ImmutableList
...
Wrapping a mutable collection::
    ...
    from nestifypy.collections import ArrayList, ImmutableList
...
class ImmutableList(Generic[T]):
    ...
    def stream(self) -> "Stream[T]":
        """Return a :class:`~nestifypy.collections.stream.Stream` backed by this list."""
    ...
    def to_mutable(self) -> "ArrayList[T]":
        """
        Return a mutable :class:`~nestifypy.collections.array_list.ArrayList` copy.
