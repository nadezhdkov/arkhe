...
from arkhe.loom.exceptions import LoomAmbiguityError, LoomScopeConflictError
...
class Resolver:
    ...
    def _extract_value(self, node: Any) -> Any:
        ...
        from arkhe.loom.ast_nodes import ListNode, LiteralNode, MapNode
    ...
    def resolve(self, path_parts: list[str]) -> Any:
        ...
        """
        if not path_parts:
            from arkhe.loom.exceptions import LoomResolutionError
