...
from typing import Any, Iterable, List, Optional as TypeOptional, Tuple, TypeVar

from arkhe.utils.optional import Optional
...
class Time:
    ...
    @staticmethod
    def format(dt: TypeOptional[datetime] = None, fmt: str = "%Y-%m-%d %H:%M:%S") -> str:
...
__all__ = ["Strings", "Random", "Time", "Math", "Colors", "Validator", "Optional"]
