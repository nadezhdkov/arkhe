...
Example::
    ...
    from arkhe.collections import Stream
...
class Stream(Generic[T]):
    ...
    def associate_by(self, key_fn: Callable[[T], K]) -> "HashMap[K, T]":
        """
        Collect elements into a :class:`~arkhe.collections.HashMap` keyed
    ...
    def associate(
        ...
        """
        Collect elements into a :class:`~arkhe.collections.HashMap` with
    ...
    def first(self) -> "Optional[T]":
        ...
        """
        from arkhe.utils.optional import Optional as Opt
        try:
