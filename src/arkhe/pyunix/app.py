...
from arkhe.pyunix.input import (
...
from arkhe.pyunix.tween import TweenManager
...
class GameAPI:
    ...
    def draw(func: Callable) -> Callable:
        """Called every frame for rendering. Use Canvas and Draw API internally."""
