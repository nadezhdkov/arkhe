...
arkhe.slogger
-----------------
SLogger – System Logger for the Arkhe framework.
...
- Optional ASCII art title banner (Arkhe logo)
...
class SLogger:
    ...
    def banner(self, compact: bool = False) -> None:
        """Print the Arkhe ASCII banner to the stream."""
    ...
    def show_banner(cls, compact: bool = False) -> None:
        """Print the Arkhe ASCII art banner to the global stream."""
