...
class WebServer:
    ...
    def build(self):
        ...
        from arkhe.ignite.decorators.controller import _CONTROLLER_REGISTRY
    ...
    def _mount_routes(self, app, instance, base_path: str):
        ...
        for name in dir(instance):
            ...
            if not callable(method):
                continue
            if not getattr(method, "__arkhe_route__", False):
                continue

            http_method: str = method.__arkhe_http_method__
            http_path: str = method.__arkhe_http_path__
